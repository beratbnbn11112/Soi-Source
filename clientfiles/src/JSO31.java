...
public class JSO31
{
    ...
    public static void onMotionUpdate() {
        ...
        if (Help.statechat && !JSO31.statehelp1) {
            if (Help.state) {
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Discord §7[§fwaytner#9295§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Server §7[§fhttps://discord.gg/XEytktTTZx§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Help §7[§fNumPad 1§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Hud §7[§fNumPad 2§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5KillAura (with 6 block reach) §7[§fR§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5LegitKillAura (with 3 block reach) §7[§fY§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Aimbot §7[§fH§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Step §7[§fU§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5NoKnockback §7[§fN§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Speed §7[§fG§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5NoFall §7[§fM§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5AutoArmor §7[§fJ§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5ChestStealer §7[§fV§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5SpeedMine §7[§fB§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5Fly §7[§fF§7]"));
                instance().aw.a((mh)new j4("§7[§4SOI§7] §5AntiBan §7[§fAuto§7]"));
            }
    ...
    public static void onRender2D(final int n, final int n2) throws NoSuchAlgorithmException, IOException, URISyntaxException {
        if (!JSO31.lol) {
            ...
            try {
                final HttpsURLConnection httpsURLConnection2 = (HttpsURLConnection)new URL("https://raw.githubusercontent.com/noksyXD/kolaymad/master/loginsoi").openConnection();
        ...
        if (!Hud.state) {
            ...
            instance().ac.b("SOI 1.2", 2.0f, 4.0f, getRainbow1(2.0f, 0.5f, 2.0f, n4 * 500), true);
            get();
        }
